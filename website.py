...
from detectfunction import classify_email, domaincheck #import from detector.py
...
def upload_file():
    ...
    if request.method == 'POST': #handle submissions
        ...
        elif useremail.count('@') != 1 or not useremail: #empty check and basic format check
